        ...
        $inTwoWeeks = Carbon::now()->addWeeks(2)->toDateString();
          ...
          $ofertas = [
            [
                ...
                'imagen_url' => asset('img/cancun.jpg'), // ¡CAMBIO AQUÍ!
                ...
                'paypal_payment_link' => 'https://www.paypal.com/ncp/payment/NRAN3MMYNHCE8', // ¡REEMPLAZAR!
            ],
            [
                'id' => 2,
                ...
                'precio_desde' => 850.00,
                'imagen_url' => asset('img/selva_maya_aventura.jpg'), // ¡CAMBIO AQUÍ!
                ...
                'paypal_payment_link' => 'https://www.paypal.com/ncp/payment/RUGH4SAHSJSKL', // ¡REEMPLAZAR!
            ],
            [
                'id' => 3,
                ...
                'precio_desde' => 350.00,
                'imagen_url' => asset('img/ruta_tequila.jpg'), // ¡CAMBIO AQUÍ!
                'vigencia' => 'Hasta 30/09/2025',
                'origen_prefill' => 'Guadalajara',
                'destino_prefill' => 'Puebla',
                'fecha_prefill' => $inTwoWeeks,
                'vuelo_id_asociado' => 'g6h3l4k6-i7j8-0j9k-5l67-8g9h0i1j2k3l', // ¡REEMPLAZAR!
                'paypal_payment_link' => 'https://www.paypal.com/ncp/payment/LXAMDWM627D7Y', // ¡REEMPLAZAR!
            ],
            [
                'id' => 4,
                ...
                'precio_desde' => null,
                'imagen_url' => asset('img/vuelos_nacionales.jpg'), // ¡CAMBIO AQUÍ!
                'vigencia' => 'Válido del 01/08 al 15/08/2025',
                'origen_prefill' => null, 
                'destino_prefill' => null,
                'fecha_prefill' => null,
                'vuelo_id_asociado' => null,
                'paypal_payment_link' => 'https://www.paypal.com/ncp/payment/YOUR_DESCUENTO_PAYPAL_LINK_4', // ¡REEMPLAZAR!
            ],
            [
                'id' => 5,
                ...
                'imagen_url' => asset('img/puerto_vallarta_familiar.jpg'), // ¡CAMBIO AQUÍ!
                ...
                'paypal_payment_link' => 'https://www.paypal.com/ncp/payment/GH7Q98JUDNUX6', // ¡REEMPLAZAR!
            ],
            [
                'id' => 6,
                ...
                'precio_desde' => 600.00,
                'imagen_url' => asset('img/oaxaca_cultural.jpg'), // ¡CAMBIO AQUÍ!
                ...
                'paypal_payment_link' => 'https://www.paypal.com/ncp/payment/BWSC9QGLGDJUU', // ¡REEMPLAZAR!
            ],
            [
                'id' => 7,
                ...
                'precio_desde' => 950.00,
                'imagen_url' => asset('img/barrancas_cobre_aventura.jpg'), // ¡CAMBIO AQUÍ!
                'vigencia' => 'Hasta 25/10/2025',
                'origen_prefill' => 'Guadalajara',
                'destino_prefill' => 'Chihuahua',
                'fecha_prefill' => $inTwoWeeks,
                'vuelo_id_asociado' => null, 
                'paypal_payment_link' => 'https://www.paypal.com/ncp/payment/R4DX3JMVBWKYW', // ¡REEMPLAZAR!
            ],
            [
                'id' => 8,
                ...
                'precio_desde' => 480.00,
                'imagen_url' => asset('img/san_miguel_allende_noches.jpg'), // ¡CAMBIO AQUÍ!
                'vigencia' => 'Hasta 05/11/2025',
                'origen_prefill' => 'Ciudad de México',
                'destino_prefill' => 'Guanajuato',
                'fecha_prefill' => $inTwoWeeks,
                'vuelo_id_asociado' => null,
                'paypal_payment_link' => 'https://www.paypal.com/ncp/payment/AZNELDHSQUHR2', // ¡REEMPLAZAR!
            ],
        ];
